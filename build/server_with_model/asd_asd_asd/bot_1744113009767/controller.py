...
class CovController():
    def __init__(self,scriptName = None,store_covtimeline=[],current_index=0,current_obj=None,current_stap_obj=None,old_obj = None):
        if scriptName == None:
            try:
                file_path = os.path.join(current_file_path.replace("controller.py",""), "scripts", "test.json")
           ...
           pass
        self.store_covtimeline = store_covtimeline
        self.current_index = current_index
        self.current_obj = current_obj
        self.current_stap_obj = current_stap_obj
